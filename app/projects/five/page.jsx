         ...
         <div className="grid p-2 grid-cols-1 gap-8 pb-8 md:grid-cols-2">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex flex-col pt-8">
                                ...
                                <span className="text-p text-slate-800">The website prioritizes a sleek, user-focused design, featuring intuitive navigation, mobile responsiveness, and high-quality visuals. Interaction and animation are key elements, ensuring an engaging user experience.
                                </span>
                            </div>
                        </div>
